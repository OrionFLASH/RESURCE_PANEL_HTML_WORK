...
- интервалы: равная ширина, заданная ширина, **ручные границы** (по умолчанию, 2 ползунка) — **целые** (`floor`/`ceil`); бейдж номера группы на бегунке; поля ввода; график `position: sticky`;
