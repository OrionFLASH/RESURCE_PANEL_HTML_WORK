...
- [v] 2.4.28: свечи строго по интервалам для всех режимов (в t.ч. разрезы)
- [w] 2.4.29: вид «Свечи·ТН» (границы по суммам, подписи — число ТН у границ); один toggle подписей; улучшенное размещение подписей
